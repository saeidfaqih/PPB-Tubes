...
class _PhoneAuthScreenState extends State<PhoneAuthScreen> {
  ...
  void loginWithPhone() async {
    auth.verifyPhoneNumber(
      ...
      codeSent: (String verificationId, int? resendToken) {
        ...
        print(
            "Code sent. OTP visibility set to true."); // Menambahkan pernyataan print
        setState(() {}); // Pastikan untuk memperbarui UI setelah mengubah state
      },
  ...
  Widget build(BuildContext context) {
    print("OTP Visibility: $otpVisibility");
    return Scaffold(
      body: Container(
